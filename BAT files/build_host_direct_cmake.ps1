# ========================================
#    SinglePing Project - Build Host Device
...
Write-Host "Building HOST DEVICE with DIRECT CMAKE..." -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""

# Navigate to project root first, then to Host device directory
...
if (-not (Test-Path "CMakeLists.txt")) {
    ...
    Write-Host "  2. Check that Host\host_device directory exists" -ForegroundColor White
...
Write-Host "Starting DIRECT CMAKE build for Host device..." -ForegroundColor Green
...
Write-Host ""
Write-Host "To flash the Host device:" -ForegroundColor Yellow
...
Write-Host "      with Ninja generator instead of problematic west build." -ForegroundColor Cyan
Write-Host ""
