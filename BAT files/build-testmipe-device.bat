...
echo     Example: build-mipe-device.bat tmt3_power_optimized
echo     Example: build-mipe-device.bat --clean ble_peripheral_test
echo.
...
:: Navigate to TestMipe directory (from BAT files folder)
cd /d "%~dp0..\TestMipe"
...
if "%rev_count%"=="" set rev_count=000
...
set output_name=TestMipe_%timestamp%.hex
